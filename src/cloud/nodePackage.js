...
export function createNodePackageReadme({ nodeName = 'Windows NUC', cloudApiUrl } = {}) {
    return [
        ...
        '',
        '1. Install Node.js 24 LTS or newer on the Windows NUC.',
        '2. Extract this ZIP to a stable folder such as C:\\PrintKinetix.',
        '3. Double-click Start Cloud Node.bat.',
        '4. Open http://localhost:3000 on the NUC to configure LAN printers.',
        '',
        'The included .env contains only local-node and controller settings.',
        'It does not include Supabase service keys, cloud admin tokens, or token pepper values.',
        '',
    ].join('\r\n');
}
