...
describe('supabase REST cloud admin methods', () => {
    it('checks cloud setup schema, RPC, and storage readiness', async () => {
        ...
        expect(status.checks).toEqual([
            ...
            { name: 'merchant_users_table', ok: true },
            { name: 'merchant_user_sessions_table', ok: true },
            { name: 'merchant_user_password_resets_table', ok: true },
            ...
            { name: 'merchant_files_table', ok: true },
            { name: 'merchant_slice_jobs_table', ok: true },
            { name: 'merchant_orders_table', ok: true },
            { name: 'merchant_order_items_table', ok: true },
            { name: 'merchant_material_reservations_table', ok: true },
            { name: 'merchant_batches_table', ok: true },
            { name: 'merchant_batch_items_table', ok: true },
            { name: 'merchant_job_events_table', ok: true },
            { name: 'merchant_job_artifacts_table', ok: true },
            { name: 'merchant_inspections_table', ok: true },
            { name: 'merchant_post_processing_tasks_table', ok: true },
            { name: 'merchant_shipments_table', ok: true },
            { name: 'merchant_shipping_labels_table', ok: true },
            { name: 'merchant_rate_cards_table', ok: true },
            { name: 'merchant_invoices_table', ok: true },
            { name: 'merchant_invoice_lines_table', ok: true },
            { name: 'merchant_webhook_endpoints_table', ok: true },
            { name: 'merchant_webhook_deliveries_table', ok: true },
            { name: 'merchant_realtime_tokens_table', ok: true },
            { name: 'merchant_adapter_events_table', ok: true },
        ...
        expect(fetchImpl.mock.calls.map(([url]) => new URL(url).pathname)).toEqual([
            ...
            '/rest/v1/merchant_users',
            '/rest/v1/merchant_user_sessions',
            '/rest/v1/merchant_user_password_resets',
            '/rest/v1/farm_nodes',
            ...
            '/rest/v1/merchant_order_items',
            '/rest/v1/merchant_material_reservations',
            '/rest/v1/merchant_batches',
            '/rest/v1/merchant_batch_items',
            '/rest/v1/merchant_job_events',
            '/rest/v1/merchant_job_artifacts',
            '/rest/v1/merchant_inspections',
            '/rest/v1/merchant_post_processing_tasks',
            '/rest/v1/merchant_shipments',
            '/rest/v1/merchant_shipping_labels',
            '/rest/v1/merchant_rate_cards',
            '/rest/v1/merchant_invoices',
            '/rest/v1/merchant_invoice_lines',
            '/rest/v1/merchant_webhook_endpoints',
            '/rest/v1/merchant_webhook_deliveries',
